...
import br.com.eclinic.Model.UsuarioModel;
import br.com.eclinic.Repository.PermissaoRepository.GrupoRepository;
import br.com.eclinic.Repository.PermissaoRepository.PermissaoRepository;
import br.com.eclinic.Repository.UsuarioRepository.UsuarioRepository;
import br.com.eclinic.Security.UsuarioSecurityModel;
...
public class UsuarioService implements UserDetailsService {
    ...
    public void salvarUsuario(UsuarioModel usuarioModel){
        ...
        for (Long id : usuarioModel.getGrupos()){


            if(id != null){

                /*CONSULTA GRUPO POR CÓDIGO*/
                grupoEntity = grupoRepository.getOne(id);
    ...
    public void alterarUsuario(UsuarioModel usuarioModel) {
        ...
        UsuarioEntity usuarioEntity = this.usuarioRepository.getOne(usuarioModel.getId());
        ...
        List<GrupoEntity> grupos = new ArrayList<GrupoEntity>();
        for(
                Long codigoGrupo : usuarioModel.getGrupos())
